...
const SMSPhones = () => {
  ...
  const pageConfig = {
    currentUrl: "sms-phone/list",
    deleteUrl: "sms-phone/delete",
    single: "SMS Phone",
    title: "SMS Phones",
  };
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <Column dataField={"sms_phone_id"} caption={"ID"} hidingPriority={8} />
        <Column
          dataField={"sms_phone_name"}
          caption={"Name"}
          hidingPriority={8}
          cellRender={(e) => {
            return (
              <a href={`#/sms-phone/edit/${e.data.sms_phone_id}`}>
                {e.data.sms_phone_name}
              </a>
            );
          }}
        />
        <Column
          dataField={"sms_phone_number"}
          caption={"Code"}
          hidingPriority={8}
        />
        <Column
        ...
        <Column
          dataField={"sms_phone_lastupdateuser"}
          caption={"User"}
          hidingPriority={6}
        />
        <Column
          dataField={"sms_phone_createdate"}
          caption={"Date"}
          dataType={"date"}
          format={"dd MMMM yyy"}
          hidingPriority={5}
