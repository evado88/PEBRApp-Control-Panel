  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <Column dataField={"id"} caption={"ID"} hidingPriority={8} />
        <Column
          dataField={"peer_navigator"}
        ...
        />
        <Column
          dataField={"next_checkin_date"}
          caption={"Next Check-in Date"}
          hidingPriority={8}
        />
        <Column
          dataField={"checkin_notes"}
          caption={"Check-in Notes"}
          hidingPriority={8}
        />
        <Column
          dataField={"checkin_type"}
          caption={"Check-in Type"}
          hidingPriority={8}
        />
        <Column
