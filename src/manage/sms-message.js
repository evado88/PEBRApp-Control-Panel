...
const SMSMessage = (props) => {
    ...
    useEffect(() => {
        ...
        const loadData = () => {
            ...
            const url = AppInfo.apiUrl + 'sms-message/id/' + id;
            ...
            axios.get(url).then((response) => {
                ...
                if (typeof response.data == 'string') {
                    ...
                    if (response.data.succeeded) {
                        ...
                        setName(response.data.items[0].SMSMessage_name);
                        setCode(response.data.items[0].SMSMessage_code);
        ...
        if (id !== 0) {
           ...
           //audit
           Assist.addAudit(window.sessionStorage.getItem("ruser"), 'SMSMessage', verb, id).then((res) => {
    ...
    const onFormSubmit = async (e) => {
        ...
        const url = AppInfo.apiUrl + 'sms-message/update';
        ...
        axios({
            ...
            if (typeof response.data == 'string') {
                ...
                if (response.data.succeeded) {
                    ...
                    if (id === 0) {
                        history.push(`/sms-message/edit/${response.data.items[0].SMSMessage_id}`);
                    }
                    ...
                    <div className="dx-fieldset">
                        ...
                        <div className="dx-field">
                            ...
                            <div className="dx-field-value">
                                <SelectBox  dataSource={AppInfo.SMSMessageList} validationMessagePosition="left" onValueChanged={(e) => setName(e.value)}
