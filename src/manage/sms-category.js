...
const SMSCategory = (props) => {
    ...
    useEffect(() => {
        ...
        const loadData = () => {
            ...
            const url = AppInfo.apiUrl + 'sms-category/id/' + id;
            ...
            axios.get(url).then((response) => {
                ...
                if (typeof response.data == 'string') {
                    ...
                    if (response.data.succeeded) {
                        ...
                        setName(response.data.items[0].sms_cat_name);
                        setDescription(response.data.items[0].sms_cat_description);
        ...
        if (id !== 0) {
           ...
           //audit
           Assist.addAudit(window.sessionStorage.getItem("ruser"), 'SMSCategory', verb, id).then((res) => {
    ...
    const onFormSubmit = async (e) => {
        ...
        const url = AppInfo.apiUrl + 'sms-category/update';
        ...
        axios({
            ...
            if (typeof response.data == 'string') {
                ...
                if (response.data.succeeded) {
                    ...
                    if (id === 0) {
                        history.push(`/sms-category/edit/${response.data.items[0].sms_cat_id}`);
                    }
                ...
                <form action="your-action" onSubmit={onFormSubmit}>
                    ...
                    <div className="dx-fieldset">
                        ...
                        <div className="dx-field">
                            ...
                            <TextBox disabled={error} onValueChanged={(e) => setName(e.value)}
                                    value={name}
